...
class WallFollower(Node):
    def __init__(self):
        ...
        self.wall_distance_ref = 1.20  # Distancia de referencia a la pared aumentada a 2 metros
        
        # PID para el ángulo
        self.steering_pid_kp = 1.10
        self.steering_pid_ki = 0.00
        self.steering_pid_kd = 0.01
        self.last_error_angle = 0.0
        self.integral_angle = 0.0

        # PID para la velocidad
        self.speed_pid_kp = 0.5
        ...
        # Ángulo de detección
        self.angle_range_deg = 45  # Ángulo configurable, 45 grados por defecto
    ...
    def select_cleanest_wall(self, ranges, angle_increment):
        ...
        points_to_check = int(np.radians(self.angle_range_deg) / angle_increment)
    ...
    def get_wall_following_angle(self, side_to_follow, side_ranges):
        # Obtiene el ángulo necesario para seguir la pared con menos obstáculos detectables
        ...
        return np.clip(steering_angle, -0.20, 0.20)
